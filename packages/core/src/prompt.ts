...
export function systemPrompt(opts: {
  ...
  return [
    ...
    "- Parallel work: spawn_agents fans out independent throwaway subtasks (you collect results yourself with task_status). spawn_team is stronger — for work that must be COORDINATED and MERGED, define a goal + roles and it launches a team that shares a blackboard; members board_post findings and board_claim_file to avoid collisions, and you are AUTOMATICALLY re-prompted with a digest when all finish so you can merge their worktrees and report. Don't poll in a loop — board_read when you want to peek. Prefer spawn_team for multi-part features, broad refactors, and research that needs synthesis.",
    opts.memory
