...
const KEYS: { keys: string; label: string }[] = [
  ...
  { keys: "Ctrl+B", label: "toggle sessions panel (full-screen on narrow terminals)" },
  { keys: "Ctrl+G", label: "toggle context panel (full-screen on narrow terminals)" },
  { keys: "Ctrl+K", label: "command palette" },
  { keys: "/effort", label: "reasoning-effort slider (←/→ · click · ⏎)" },
